...
namespace WebBanThatLung.Controllers
{
    public class DonHangController : Controller
    {
        ...
        public async Task<IActionResult> CancelOrder(int orderId, int productId)
        {
            ...
            // Cập nhật số lần hủy đơn hàng của người dùng
            khachHang.CancelCount++;
            if (khachHang.CancelCount > 3)
            {
                // Khóa tài khoản người dùng
                khachHang.LockoutEndDate = DateTime.Now.AddDays(3);
                ...
                // Đăng xuất người dùng và thông báo khóa tài khoản
                TempData["Error"] = "Tài khoản của bạn đã bị khóa 3 ngày do hủy đơn hàng quá 3 lần.";
                return RedirectToAction("Login", "NguoiDung");
            }
