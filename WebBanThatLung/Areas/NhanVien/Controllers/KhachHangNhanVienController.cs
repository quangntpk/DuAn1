...
namespace WebBanThatLung.Areas.NhanVien.Controllers
{
    ...
    public class KhachHangNhanVienController : Controller
    {
        ...
        public KhachHangNhanVienController(DataContext dataContext, IWebHostEnvironment webHostEnvironment)
        {
        ...
        //GET: KhachHangNhanVien/ListKhachHang

        [Route("NhanVien/KhachHangNhanVien")]
        public async Task<IActionResult> ListKhachHangNhanVien(int page = 1, int pageSize = 10)
        {
        ...
        public async Task<IActionResult> Create(NguoiDungModel nguoiDungModel, IFormFile HINH_ANH)
        {
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction(nameof(ListKhachHangNhanVien));
            }
        ...
        // GET: KhachHangNhanVien/Delete/5
        ...
        // POST: KhachHangNhanVien/Delete/5
